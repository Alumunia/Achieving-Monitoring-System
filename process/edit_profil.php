<?php
	...
	$lamapassword = $_POST['lamapassword'];
	
	$pass = mysqli_query($con, "SELECT * FROM siswa WHERE username='$username'");
	$pass12 = mysqli_fetch_array($pass);
	
	
	if ($lamapassword==$pass12['password']){
