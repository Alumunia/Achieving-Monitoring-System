            ...
            <li class="treeview <?php echo $table_profil;?>">
			 ...
			 <li class="treeview <?php echo $table_chart;?>">
              <a href="../pages/table_chart.php">
                ...
                <li class="active"><a href="../pages/table_chart1.php"><i class="fa fa-circle-o"></i> Bahasa Indonesia</a></li>
                <li><a href="../pages/table_chart2.php"><i class="fa fa-circle-o"></i> Matematika</a></li>
                <li><a href="../pages/table_chart3.php"><i class="fa fa-circle-o"></i> Fisika</a></li>
                <li><a href="../pages/table_chart4.php"><i class="fa fa-circle-o"></i> Bahasa Inggris</a></li>
                <li><a href="../pages/table_chart5.php"><i class="fa fa-circle-o"></i> Kimia</a></li>
                <li><a href="../pages/table_chart6.php"><i class="fa fa-circle-o"></i> Biologi</a></li>
