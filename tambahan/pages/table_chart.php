            ...
            <div class="col-md-6">
              ...
              <div class="box box-warning">
                <div class="box-header">
                  <h3 class="box-title">Bahasa Indonesia</h3>
                </div>
            ...
            <div class="col-md-6">
			 ...
			 <div class="col-md-6">
              ...
              <div class="box box-default">
                <div class="box-header">
                  <h3 class="box-title">Bahasa Inggris</h3>
                </div>
                <div class="box-body chart-responsive">
      ...
      $(function () {
	   ...
	   $(function () {
        ...
        var line = new Morris.Line({
          ...
          data: [
		  <?php
			$qr = mysqli_query($con,"SELECT * FROM nilai where siswa_username ='$username' AND Mapel_idMapel='1' ");
        ...
        var line = new Morris.Line({
          ...
          data: [
		  <?php
			$qr = mysqli_query($con,"SELECT * FROM nilai where siswa_username ='$username' AND Mapel_idMapel='2' ");
			while ($tod = mysqli_fetch_assoc($qr)) { 
		  ?>
            {year: '<?php echo $tod['Semester']?>', item1: '<?php echo $tod['Nilai']?>'},
		  <?php } ?>
        ...
        var line = new Morris.Line({
          ...
          data: [
		  <?php
			$qr = mysqli_query($con,"SELECT * FROM nilai where siswa_username ='$username' AND Mapel_idMapel='3' ");
			while ($tod = mysqli_fetch_assoc($qr)) { 
		  ?>
            {year: '<?php echo $tod['Semester']?>', item1: '<?php echo $tod['Nilai']?>'},
		  <?php } ?>
        ...
        var line = new Morris.Line({
          ...
          data: [
		  <?php
			$qr = mysqli_query($con,"SELECT * FROM nilai where siswa_username ='$username' AND Mapel_idMapel='4' ");
			while ($tod = mysqli_fetch_assoc($qr)) { 
		  ?>
            {year: '<?php echo $tod['Semester']?>', item1: '<?php echo $tod['Nilai']?>'},
		  <?php } ?>
