...
include'../layout/identifier.php';
	...
	$qry = mysqli_query($con,"SELECT * FROM artikel WHERE idartikel='$id'  ");
          ...
          <div class="row">
			...
			<div class="col-md-12">
                ...
                <div class="box-body box-info">
						...
						<form action="../process/submit_nilai.php?username=<?php echo $username ?>&Semester=<?php echo $getsemester; ?>" method="post">
						...
						<div class="row no-print">
							...
							<label>Nilai</label>
								...
								<?php
				$no=0;
				$result = mysqli_query($con,"SELECT * FROM nilai JOIN mapel WHERE siswa_username='$username' AND Mapel_idMapel=idMapel AND Semester=$getsemester")
				or die(mysqli_error());
				...
				?>
							<div class="row">
							 ...
							 <div class="col-xs-6">
								<label></label>
							 <input name="Nilai[]" value="<?php echo $row['Nilai'];?>"class="form-control /">
							  </div>
							  </div>
							  <?php } ?>
							</div>
