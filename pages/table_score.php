      ...
      <div class="content-wrapper">
		...
		<li class="dropdown">
         ...
         <li class="dropdown">
          ...
          <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
            <li><a href="#sem3" tabindex="-1" data-toggle="tab">Semester 1</a></li>
            <li><a href="#sem4" tabindex="-1" data-toggle="tab">Semester 2</a></li>
          </ul>
        </li>
        <li class="dropdown">
          <a href="#" id="myTabDrop1" class="dropdown-toggle" data-toggle="dropdown">Kelas XII <b class="caret"></b></a>
          <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
            <li><a href="#sem5" tabindex="-1" data-toggle="tab">Semester 1</a></li>
            <li><a href="#sem6" tabindex="-1" data-toggle="tab">Semester 2</a></li>
          </ul>
        </li>
</ul>
...
<?php } ?>   
				  ...
				  <?php if ($level=='admin'){?>
				  <a type="button" class="btn btn-success" href="edit_nilai.php?usernameget=<?php echo $user?>&Semester=1">EDIT</a>
...
<?php } ?>   
				   ...
				   <?php if ($level=='admin'){?>
				  <a type="button" class="btn btn-success" href="edit_nilai.php?usernameget=<?php echo $user?>&Semester=2">EDIT</a>
    ...
    <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
						...
						<?php
$no=1;
$result = mysqli_query($con,"SELECT * FROM nilai JOIN mapel WHERE siswa_username='$username' AND Mapel_idMapel=idMapel  AND Semester=3") 
or die(mysqli_error());  
...
<?php } ?>   
				   ...
				   <?php if ($level=='admin'){?>
				  <a type="button" class="btn btn-success" href="edit_nilai.php?usernameget=<?php echo $user?>&Semester=3">EDIT</a>
    ...
    <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      ...
                      <th>No</th>
						...
						<?php
$no=1;
$result = mysqli_query($con,"SELECT * FROM nilai JOIN mapel WHERE siswa_username='$username' AND Mapel_idMapel=idMapel  AND Semester=4") 
or die(mysqli_error());  
...
<?php } ?>   
				   ...
				   <?php if ($level=='admin'){?>
				  <a type="button" class="btn btn-success" href="edit_nilai.php?usernameget=<?php echo $user?>&Semester=4">EDIT</a>
    ...
    <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      ...
                      <th>No</th>
						...
						<?php
$no=1;
$result = mysqli_query($con,"SELECT * FROM nilai JOIN mapel WHERE siswa_username='$username' AND Mapel_idMapel=idMapel  AND Semester=5") 
or die(mysqli_error());  
...
<?php } ?>   
				   ...
				   <?php if ($level=='admin'){?>
				  <a type="button" class="btn btn-success" href="edit_nilai.php?usernameget=<?php echo $user?>&Semester=5">EDIT</a>
    ...
    <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      ...
                      <th>No</th>
						...
						<?php
$no=1;
$result = mysqli_query($con,"SELECT * FROM nilai JOIN mapel WHERE siswa_username='$username' AND Mapel_idMapel=idMapel  AND Semester=6") 
or die(mysqli_error());  
...
<?php } ?>   
				   ...
				   <?php if ($level=='admin'){?>
				  <a type="button" class="btn btn-success" href="edit_nilai.php?usernameget=<?php echo $user?>&Semester=6">EDIT</a>
